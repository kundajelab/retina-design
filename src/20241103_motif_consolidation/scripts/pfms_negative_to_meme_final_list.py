...
parser.add_argument("-i", "--input-pfms", type=str,  required=True, help="Third col of form negative_cts2_pattern_11, 4th col has name")
...
with open(args.input_pfms) as f:
    for line in f:
        mot = line.strip().split('\t')[2] # form negative_cts2_pattern_11
        mot = mot.replace("negative_", "")
...
pfms = []
for m,n in motifs:
    with open("pfms_negative/" + m) as f:
